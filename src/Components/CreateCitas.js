  ...
  return (
    <div className="mt-20 lg:mt-4">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className=' flex flex-col w-2/3 m-auto text-black'>
        <input className='my-2' {...register("name", { required: "Digite su nombre" })} placeholder='Nombre' />
        ...
        <div className='flex justify-evenly'>
          ...
          <span className='text-white'>Marca para que la Cita no este disponible para otras personas</span>
        </div>
